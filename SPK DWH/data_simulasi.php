...
<div class="container" style='margin-top:90px'>
  <div class="row">
    <div class="col-12 mt-5">
      ...
      <p class="desc">Berikut adalah data acuan yang digunakan dalam membangun sistem untuk mendapatkan Prediksi Kelulusan Pelamar Kerja menggunakan metode naive bayes.<br></p>
